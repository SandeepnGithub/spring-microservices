...
public class PetApiController implements PetApi {
    ...
    public ResponseEntity<Void> addPet(@ApiParam(value = "Pet object that needs to be added to the store" ,required=true )  @Valid @RequestBody Body1 body) {
        // do some magic!
    ...
    public ResponseEntity<Void> updatePet(@ApiParam(value = "Pet object that needs to be added to the store" ,required=true )  @Valid @RequestBody Body body) {
        // do some magic!
        return new ResponseEntity<Void>(HttpStatus.OK);
    }
